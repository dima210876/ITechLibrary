...
public class BorrowBooksCopyDamagePhotoDao implements ComplexDao<BorrowBooksCopyDamagePhoto>
{
    ...
    public long create(Connection conn, BorrowBooksCopyDamagePhoto borrowBooksCopyDamagePhoto)
    {
        ...
        try
        {
            statement = conn.prepareStatement(CREATE_BORROW_BOOKS_COPY_DAMAGE_PHOTO_SQL, Statement.RETURN_GENERATED_KEYS);
