...
public class BorrowBooksCopyDao implements DefaultDao<BorrowBooksCopy>
{
    ...
    @Override
    public Optional<BorrowBooksCopy> create(BorrowBooksCopy borrowBooksCopy)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
        {
            conn = POOL.retrieveConnection();
            statement = conn.prepareStatement(CREATE_BORROW_BOOKS_COPY_SQL);
    ...
    @Override
    public Optional<BorrowBooksCopy> update(BorrowBooksCopy borrowBooksCopy)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
        {
            ...
            return Optional.of(borrowBooksCopy);
        }
        catch (SQLException e)
        {
