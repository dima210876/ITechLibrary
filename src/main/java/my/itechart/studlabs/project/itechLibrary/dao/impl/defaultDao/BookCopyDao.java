...
public class BookCopyDao implements DefaultDao<BookCopy>
{
    ...
    @Override
    public Optional<BookCopy> create(BookCopy bookCopy)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
        {
            conn = POOL.retrieveConnection();
            statement = conn.prepareStatement(CREATE_BOOK_COPY_SQL);
    ...
    @Override
    public Optional<BookCopy> update(BookCopy bookCopy)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
