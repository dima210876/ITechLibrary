...
public class BookCoverPhotoDao implements DefaultDao<BookCoverPhoto>
{
    ...
    @Override
    public Optional<BookCoverPhoto> create(BookCoverPhoto bookCoverPhoto)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
        {
            conn = POOL.retrieveConnection();
            statement = conn.prepareStatement(CREATE_BOOK_COVER_PHOTO_SQL);
    ...
    @Override
    public Optional<BookCoverPhoto> update(BookCoverPhoto bookCoverPhoto)
    {
        PreparedStatement statement = null;
        Connection conn = null;
        try
        {
            ...
            return Optional.of(bookCoverPhoto);
        }
        catch (SQLException e)
        {
